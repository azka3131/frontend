...
export default function AchievementTable({ items, onCreate, onEdit, onDelete }: Props) {
  ...
  return (
    <div className="rounded-xl border bg-white shadow-sm overflow-hidden">
      <div className="flex items-center justify-between border-b p-5">
        <div>
          <h2 className="text-xl font-bold">Prestasi Sekolah</h2>
          <p className="text-sm text-muted-foreground">Kelola daftar penghargaan dan prestasi</p>
        </div>
        ...
        <table className="w-full">
          <thead className="bg-slate-50">
            <tr>
              ...
              <th className="p-4 text-left font-medium text-gray-500">Judul Prestasi</th>
              <th className="p-4 text-left font-medium text-gray-500">Tahun</th>
          ...
          <tbody>
            ...
            {filteredItems.length === 0 && (
              <tr>
                <td colSpan={4} className="p-8 text-center text-gray-500">Tidak ada data prestasi.</td>
              </tr>
            )}
          </tbody>
        </table>
